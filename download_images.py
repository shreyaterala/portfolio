...
image_data = {
  ...
  "haptic_museum": "https://foremost-tumble-c4f.notion.site/image/attachment%3A5daa99cb-b192-44fe-9914-96075ac7382f%3AIMG_1573.jpeg?id=28bf0849-6609-804d-a80c-c71194a348f7&table=block&spaceId=445a6413-2ed1-4f4f-80e1-114dc4e4b5bb&width=640&userId=&cache=v2",
...
for name, url in image_data.items():
    try:
        ...
        # Simple Logic to guess extension if not clear, but Notion URLs usually have clean file paths once encoded
        # Notion image proxy URLs often don't end in .jpg directly in the main path, but let's try to infer or default to jpg
        ...
        if response.status_code == 200:
            ...
            # Manual override if URL strongly suggests otherwise
            if ".png" in url:
                ext = ".png"
            if ".webp" in url:
                ext = ".webp"
