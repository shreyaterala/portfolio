...
export default async function Home() {
    ...
    return (
        <div className="w-full pb-24">
            ...
            <section className="min-h-[calc(100vh-5rem)] flex flex-col justify-center items-start md:items-center relative border-b border-slate-200/50 overflow-hidden">
